...
const navLinks: NavLink[] = [
  ...
  { href: "/livestream", label: "Livestream", id: "livestream" },
];
      ...
      <header className="site-header">
        <div className="container nav">
          ...
          <nav className={menuOpen ? "nav-links open" : "nav-links"} aria-label="Main navigation">
            {navLinks.map((link) => (
              <a
                className={`${activeSection === link.id ? "active " : ""}${link.id === "livestream" ? "livestream-nav-link" : ""}`.trim()}
                href={link.href}
                key={link.id}
              >
                {link.id === "livestream" ? (
        ...
        <div className="container hero-grid">
          ...
          <div className="hero-media-stack">
            ...
            <a className="livestream-home-link" href="/livestream">
              <span><Radio size={19} /> Watch CMN TV online</span>
              <ArrowRight size={19} />
            </a>
          </div>
        </div>
